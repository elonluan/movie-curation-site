import{m as o,l as d,p as u}from"./common-BJ_CqIzc.js";function p(){return new URLSearchParams(window.location.search).get("id")}function c(){const a=document.querySelector("#movie-detail");a.innerHTML=`
    <div class="empty">
